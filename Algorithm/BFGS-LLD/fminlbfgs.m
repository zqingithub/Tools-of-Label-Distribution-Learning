...
defaultopt = struct('Display','iter','HessUpdate','bfgs','GoalsExactAchieve',0,'GradConstr',true,  ...
			'TolX',1e-21,'TolFun',1e-21,'GradObj','on','MaxIter',400,'MaxFunEvals',100*numel(xInit)-1,  ...
...
if(optim.HessUpdate(1)=='b') 
    if(data.numberOfVariables<300000), 
